...
import com.example.android.prototype2.CoachAdviceActivity;
...
public class CoachLoginInstrumentationPage {

    @Rule
    public ActivityTestRule<CoachLoginActivity> mActivityTestRule =
            new ActivityTestRule<>(CoachLoginActivity.class);
